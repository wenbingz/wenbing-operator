...
func (r *WenbingCustomReconciler) ensureService(request reconcile.Request,
...
func (r *WenbingCustomReconciler) backendService(v *mydomainv1alpha1.WenbingCustom) *corev1.Service {
	labels := labels(v, "backend")

	service := &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "backend-wenbing-service",
